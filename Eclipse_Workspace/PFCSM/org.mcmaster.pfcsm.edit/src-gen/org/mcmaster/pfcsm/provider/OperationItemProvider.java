...
public class OperationItemProvider extends ElementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_returnType_feature",
								"_UI_Operation_type"),
						PfcsmPackage.Literals.OPERATION__RETURN_TYPE, true, false, false,
	...
	protected void addPublicPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Operation_public_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_public_feature",
								"_UI_Operation_type"),
						PfcsmPackage.Literals.OPERATION__PUBLIC, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PfcsmPackage.Literals.OPERATION__STATE);
			childrenFeatures.add(PfcsmPackage.Literals.OPERATION__TRANSITION);
			childrenFeatures.add(PfcsmPackage.Literals.OPERATION__OPERATIONVARIABLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(PfcsmPackage.Literals.OPERATION__STATE, PfcsmFactory.eINSTANCE.createState()));

		newChildDescriptors.add(createChildParameter(PfcsmPackage.Literals.OPERATION__TRANSITION,
				PfcsmFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add(createChildParameter(PfcsmPackage.Literals.OPERATION__OPERATIONVARIABLE,
