...
/**
 * This is the item provider adapter for a {@link org.mcmaster.pfcsm.ModelRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelRootItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PfcsmPackage.Literals.MODEL_ROOT__CLASS);
			childrenFeatures.add(PfcsmPackage.Literals.MODEL_ROOT__REFERENCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PfcsmPackage.Literals.MODEL_ROOT__CLASS,
				PfcsmFactory.eINSTANCE.createAbstractClass()));

		newChildDescriptors.add(createChildParameter(PfcsmPackage.Literals.MODEL_ROOT__CLASS,
				PfcsmFactory.eINSTANCE.createConcreteClass()));

		newChildDescriptors.add(createChildParameter(PfcsmPackage.Literals.MODEL_ROOT__REFERENCE,
		...
		newChildDescriptors.add(
				createChildParameter(PfcsmPackage.Literals.MODEL_ROOT__REFERENCE, PfcsmFactory.eINSTANCE.createXOR()));

		newChildDescriptors.add(
				createChildParameter(PfcsmPackage.Literals.MODEL_ROOT__REFERENCE, PfcsmFactory.eINSTANCE.createUses()));
