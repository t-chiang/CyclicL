...
/**
 * This is the item provider adapter for a {@link org.mcmaster.pfcsm.Composition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositionItemProvider extends ReferenceItemProvider {
	...
	protected void addTgtMultPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Composition_tgtMult_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Composition_tgtMult_feature",
	...
	public String getText(Object object) {
		String label = ((Composition) object).getTgtMult();
