...
/**
 * This is the item provider adapter for a {@link org.mcmaster.traceability_matrix.tmat.ID} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IDItemProvider extends ProjectRequirementsItemProvider {
	/**
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ID_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ID_id_feature", "_UI_ID_type"),
						TmatPackage.Literals.ID__ID, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
						null, null));
	}
	...
	public String getText(Object object) {
		ID id = (ID) object;
		return getString("_UI_ID_type") + " " + id.getId();
	}
