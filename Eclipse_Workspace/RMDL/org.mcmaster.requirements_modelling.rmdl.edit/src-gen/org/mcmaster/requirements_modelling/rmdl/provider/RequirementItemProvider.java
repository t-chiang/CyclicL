...
/**
 * This is the item provider adapter for a {@link org.mcmaster.requirements_modelling.rmdl.Requirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementItemProvider extends EntityItemProvider {
	/**
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RmdlPackage.Literals.REQUIREMENT__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Requirement_description_feature",
								"_UI_Requirement_type"),
						RmdlPackage.Literals.REQUIREMENT__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVerifyMethodPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Requirement_verifyMethod_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Requirement_verifyMethod_feature",
								"_UI_Requirement_type"),
						RmdlPackage.Literals.REQUIREMENT__VERIFY_METHOD, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addChildPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Requirement_child_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Requirement_child_feature",
								"_UI_Requirement_type"),
						RmdlPackage.Literals.REQUIREMENT__CHILD, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Requirement_parent_feature",
								"_UI_Requirement_type"),
						RmdlPackage.Literals.REQUIREMENT__PARENT, true, false, true, null, null, null));
	}
