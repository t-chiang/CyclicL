...
public class PackageItemProvider extends EntityItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RmdlPackage.Literals.PACKAGE__REQUIREMENT);
			childrenFeatures.add(RmdlPackage.Literals.PACKAGE__ENTITY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RmdlPackage.Literals.PACKAGE__REQUIREMENT,
		...
		newChildDescriptors.add(
				createChildParameter(RmdlPackage.Literals.PACKAGE__REQUIREMENT, RmdlFactory.eINSTANCE.createSafety()));

		newChildDescriptors.add(
				createChildParameter(RmdlPackage.Literals.PACKAGE__ENTITY, RmdlFactory.eINSTANCE.createFunctional()));

		newChildDescriptors.add(
				createChildParameter(RmdlPackage.Literals.PACKAGE__ENTITY, RmdlFactory.eINSTANCE.createQualitative()));

		newChildDescriptors.add(
				createChildParameter(RmdlPackage.Literals.PACKAGE__ENTITY, RmdlFactory.eINSTANCE.createConstraint()));

		newChildDescriptors
				.add(createChildParameter(RmdlPackage.Literals.PACKAGE__ENTITY, RmdlFactory.eINSTANCE.createPackage()));

		newChildDescriptors
				.add(createChildParameter(RmdlPackage.Literals.PACKAGE__ENTITY, RmdlFactory.eINSTANCE.createSafety()));

		newChildDescriptors.add(createChildParameter(RmdlPackage.Literals.PACKAGE__ENTITY,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == RmdlPackage.Literals.PACKAGE__REQUIREMENT
				|| childFeature == RmdlPackage.Literals.PACKAGE__ENTITY;
